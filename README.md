...
| پلتفرم | فایل انتشار |
|---|---|
| Windows x64 | `DicodeConfigChecker-v1.4.0-windows-x64.exe` |
| Linux x86_64 | `DicodeConfigChecker-v1.4.0-linux-x86_64.tar.gz` |
| Android | `DicodeConfigChecker-v1.4.0-android.apk` |
